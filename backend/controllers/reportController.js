...
const exportTasksReport = async (req, res) => {
    try {
        ...
        tasks.forEach((task) => {
            const assignTo = task.assignedTo
...
// @desc Export user specific tasks as Excel file
...
const exportUserReport = async (req, res) => {
    try {
        ...
        worksheet.columns = [
            ...
            { header: "Total Assigned Tasks", key: "tasksCount", width: 15 },
        ...
        res 
        .status(500)
        .json({ message: "Error exporting user task report", error: error.message });
    }
}
